...
// Edge slides adjust the frontlight in 1-point steps over the same distance
// scale as amount(): the first step lands as soon as the slide is recognized
// and a full-axis slide covers the entire 0-100 range.
